...
$msg-padding: 9.2px !default;
$msg-border-radius: 4px !default;
$msg-icon-size: 16px !default;
$msg-icon-margin: 0 !default;
$msg-close-icon-margin: 2px 2px 2px auto !default;
$msg-close-icon-size: 12px !default;
$msg-close-icon-padding: 0 !default;
$msg-close-icon-height: 12px !default;
...
$msg-bigger-padding: 8.2px 10.2px 10.2px 10.2px !default;
$msg-bigger-icon-size: 18px !default;
$msg-bigger-icon-margin: 0 !default;
$msg-bigger-close-icon-margin: 4px 5px 2px auto !default;
$msg-bigger-close-icon-padding: 0 !default;
$msg-bigger-close-icon-height: 14px !default;
$msg-bigger-close-icon-size: 14px !default;
$msg-bigger-content-font-size: 14px !default;
$msg-bigger-content-line-height: 20px !default;
...
$msg-error-icon-color: $danger-shade-10 !default;

$msg-close-icon-color: $msg-icon-color !default;
...
$msg-filled-error-icon-color: $msg-danger-color-alt2 !default;

$msg-filled-close-icon-color: $msg-icon-color-alt2 !default;
